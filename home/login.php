    ...
    <div id="all">
        <div id="admin_login">
            <form id="form" method="post" action="../admin/adminlogin.php">
                ...
                <input id="name" type="text" name="admin" required="required"><br><br>
                <label for="pass">管理员密码:</label><br>
                <input id="pass" type="password" name="password" required="required"><br><br>
                <label for="code">验证码:</label><br>
                <input id="code" type="text" name="authcode" required="required"><br><br>
